 ...
 * @param {number} stepMeters target spacing
 */
export function densifyRoute(coords, stepMeters = 400) {
 ...
 * @param {Date} depart
 * @param {number} durationSeconds total trip duration from router
 */
export function timestampRoute(points, depart, durationSeconds) {
